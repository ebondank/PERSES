...
failureFile.write('\n\n\n')
failureFile.close()
failureFile = open('noTime_noCC_ironPipeFail.txt', 'a')
failureFile.write('\n\n\n')
failureFile.close()
failureFile = open('noTime_noCC_pvcPipeFail.txt', 'a')
failureFile.write('\n\n\n')
failureFile.close()
failureFile = open('noTime_noCC_pumpFail.txt', 'a')
failureFile.write('\n\n\n')
failureFile.close()
failureFile = open('noTime_yesCC_ironPipeFail.txt', 'a')
failureFile.write('\n\n\n')
failureFile.close()
failureFile = open('noTime_yesCC_pvcPipeFail.txt', 'a')
failureFile.write('\n\n\n')
failureFile.close()
failureFile = open('noTime_yesCC_pumpFail.txt', 'a')
failureFile.write('\n\n\n')
failureFile.close()
